...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">invensystem documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/PosComponent.html" data-type="entity-link" >PosComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/SupplierComponent.html" data-type="entity-link" >SupplierComponent</a>
                            </li>
                            <li class="link">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/InventoryDataService.html" data-type="entity-link" >InventoryDataService</a>
                                </li>
                                <li class="link">
                                    <a href="injectables/SupplierDataService.html" data-type="entity-link" >SupplierDataService</a>
                                </li>
                                <li class="link">
